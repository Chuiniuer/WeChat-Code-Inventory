...
output_file = r"F:\climate extremes\TN10p\threshold\TNin10.tif"
os.makedirs("F:\\climate extremes\\TN10p\\threshold", exist_ok=True)
# 目标基准期
